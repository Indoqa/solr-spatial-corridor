...
public class AngleDistanceValueSource extends ValueSource {

    private static final Logger LOGGER = LoggerFactory.getLogger(AngleDistanceValueSource.class);
    ...
    protected AngleDistanceValueSource(List<Point> queryPoints, ValueSource routeValueSource, ValueSource routeHashValueSource,
    ...
    public boolean equals(Object o) {
        if (!(o instanceof AngleDistanceValueSource)) {
            return false;
        }

        AngleDistanceValueSource other = (AngleDistanceValueSource) o;
    ...
    protected double getValue(LineString lineString) {
        Coordinate queryCoordinate1 = this.queryPoints.get(0).getCoordinate();
        return AngleUtils.getAngleDistance(lineString, queryCoordinate1, new LocationIndexedLine(lineString));
    }
    ...
    private final class InverseCorridorDocValues extends DoubleDocValues {
        ...
        public double doubleVal(int docId) {
            ...
            try {
                ...
                return AngleDistanceValueSource.this.getValue(route);
            } catch(Exception e){
